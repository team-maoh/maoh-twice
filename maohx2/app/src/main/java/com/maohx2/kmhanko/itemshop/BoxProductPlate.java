...
public class BoxProductPlate extends BoxItemPlate {
    ...
    public void draw() {
        ...
        graphic.bookingDrawBitmapData(flameElement[1][0], position[0], position[1] + height / 3, 1.0f, 1.0f, 0, 255, true);
        ...
        graphic.bookingDrawBitmapData(flameElement[1][2], position[2] - width / 3, position[1] + height / 3, 1.0f, 1.0f, 0, 255, true);
