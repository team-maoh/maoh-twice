 ...
 *
 *
 * GeoNodeをデバッグするための仮のクラス。藤原が作る予定
 */
...
public class GeoObject {
    ...
    public GeoObject(int _hp, int _attack, int _defence, int _luck, double _hp_rate, double _attack_rate, double _defence_rate, double _luck_rate) {
        hp = _hp;
        attack = _attack;
        defence = _defence;
        luck = _luck;
