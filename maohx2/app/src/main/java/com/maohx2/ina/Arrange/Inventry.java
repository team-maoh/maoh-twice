...
public class Inventry {
    ...
    public Inventry(UserInterface _user_interface, Graphic graphic, EquipmentItemDataAdmin _equipment_item_data_admin){
        ...
        for(int i = 0; i< INVENTRY_DATA_MAX; i++){
            if(i%2 == 0) {
                inventry_datas[i] = new InventryData((ItemData) equipment_item_data_admin.getOneDataByName("破壊の剣"), 9);
            }else{
                inventry_datas[i] = new InventryData((ItemData) equipment_item_data_admin.getOneDataByName("水の弓"), 9);
            }
        }
