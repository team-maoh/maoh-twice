...
public class GeoSlotAdmin {
    ...
    //GeoSlot geo_slots[] = new GeoSlot[GEO_SLOT_MAX];
    ...
    static public void setDatabase(MyDatabase _database) {
        database = _database;
    }
    ...
    public void loadDatabase(String _t_name) {
        ...
        for(int i = 0; i < geo_slots.size(); i++) {
            ...
            geo_slots.get(i).setParam((int) (xs.get(i) * 2000.0), (int) (ys.get(i) * 1500.0), r);
            geo_slots.get(i).setTouchID(user_interface.setCircleTouchUI((int) (xs.get(i) * 2000.0), (int) (ys.get(i) * 1500.0), r+10));
